...
// @ts-ignore
            ...
            const infoResult: any = await tool.execute('info_child2', { operation: 'info', sessionId: child2Id });
// @ts-ignore
    ...
    describe('switch operation', () => {
        it('should switch to a specific session by ID', async () => {
            const createResult: any = await tool.execute('switch_create', { operation: 'create', name: 'child' });
// @ts-ignore
...
// @ts-ignore
        ...
        it('should throw when switching to non-existent session', async () => {
            const result: any = await tool.execute('switch_fail', { operation: 'switch', sessionId: 'nonexistent' });
// @ts-ignore
...
// @ts-ignore
            const childId = createResult.details.sessionId;
            const result: any = await tool.execute('switch_already2', { operation: 'switch', sessionId: childId });
// @ts-ignore
            expect(result.isError).toBe(true);
// @ts-ignore
...
// @ts-ignore
    ...
    describe('info operation', () => {
        it('should show detailed info for a session', async () => {
            const createResult: any = await tool.execute('info1', { operation: 'create', name: 'info-child', tags: ['tag1', 'tag2'] });
// @ts-ignore
            const childId = createResult.details.sessionId;
...
// @ts-ignore
    ...
    describe('rename operation', () => {
        it('should rename a session', async () => {
            const createResult: any = await tool.execute('rename1', { operation: 'create', name: 'old-name' });
// @ts-ignore
...
// @ts-ignore
        ...
        it('should remove tags', async () => {
            const createResult: any = await tool.execute('tag_rem1', { operation: 'create', tags: ['a', 'b'] });
// @ts-ignore
            const sessionId = createResult.details.sessionId;
...
// @ts-ignore
            ...
            const listResult: any = await tool.execute('del3', { operation: 'list', includeDisposed: true });
// @ts-ignore
