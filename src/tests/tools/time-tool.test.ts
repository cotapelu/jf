...
describe('GetTimeTool', () => {
  it('should return time in UTC by default', async () => {
    const result: any = await getTimeTool.execute('call', {}, undefined, undefined, { cwd: '.' } as any);
  ...
  it('should accept custom timezone', async () => {
    const result: any = await getTimeTool.execute('call', { timezone: 'America/New_York' }, undefined, undefined, { cwd: '.' } as any);
  ...
  it('should handle invalid timezone with error', async () => {
    const result: any = await getTimeTool.execute('call', { timezone: 'Invalid/Zone' }, undefined, undefined, { cwd: '.' } as any);
