...
import type { AgentMessage, MessageRenderer } from "@quangtynu/pi-web-ui";
import { defaultConvertToLlm, registerMessageRenderer } from "@quangtynu/pi-web-ui";
...
declare module "@quangtynu/pi-agent-core" {
