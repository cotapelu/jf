import type { OAuthProviderInterface, SimpleApiKeyProvider } from "@mariozechner/pi-ai";
import { getOAuthProviders, getSimpleApiKeyProviders } from "@mariozechner/pi-ai/oauth";
