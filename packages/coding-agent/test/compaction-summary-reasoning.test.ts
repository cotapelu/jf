...
import type { AssistantMessage, Model } from "@quangtynu/pi-ai";
...
vi.mock("@quangtynu/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@quangtynu/pi-ai")>();
	return {
		...actual,
