 ...
 */
export declare function autoCompactDirectory(dirPath: string, options?: AutoCompactOptions & {
 ...
 */
export declare function autoCompact(target: string, options?: AutoCompactOptions & {
    extensions?: string[];
    maxFileSize?: number;
}): Promise<AutoCompactResult[]>;
